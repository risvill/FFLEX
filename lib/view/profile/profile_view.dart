...
class _ProfileViewState extends State<ProfileView> {
  bool positive = false;
  List accountArr = [
    {"image": "assets/img/p_personal.png", "name": "Персональные данные", "tag": "1"},
  ];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var iObj = workoutProgress[index] as Map? ?? {};
                        return SettingRow(
                          icon: iObj["image"].toString(),
                          title: iObj["name"].toString(),
                          onPressed: () {
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            CustomAnimatedToggleSwitch<bool>(
                              ...
                              onTap: (TapProperties<bool> tapProperties) => setState(() => positive = !positive),
