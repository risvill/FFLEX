...
class _HomeViewState extends State<HomeView> {
  ...
  return isWeekSelected ? [lineChartBarData1_1, lineChartBarData1_2] : [lineChartBarData1_1_monthly, lineChartBarData1_2_monthly];
  }
  ...
  List lastWorkoutArr = [
    ...
    {
      "name": "Тренировка на нижнию часть тела",
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    IconButton(
                        onPressed: () {
                          ...
                          //   ),
                          // );
                          Navigator.of(context).push(_animatedPages());
                        },
                        icon: Image.asset(
                                          ...
                                          builder: (context) => AlertDialog(
                                            actions: [
                                              TextButton(
                                                ...
                                                child: const Text('Успокоится'),
                                              ),
                                            ],
                                            title: const Text('ИМТ (Индекс Массы Тела)'),
                                            contentPadding: const EdgeInsets.all(20.0),
                                            content: const Text(
                                                'Да нормальный у тебя вес, боже успокойся уже. Хватит гнаться за ненормальным! Тупица'),
                                          ),
                                        );
                                      }))
                            ],
                ...
                //Конец тренировочного прогресса
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
  ...
  Route _animatedPages() {
  var duration = const Duration(milliseconds: 1000); // Определение переменной duration
  ...
  return PageRouteBuilder(
    ...
    transitionDuration: duration, // Использование переменной duration для задания продолжительности анимации
  );
}
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
      ...
      LineChartBarData get lineChartBarData1_1_monthly => LineChartBarData(
        isCurved: true,
        gradient: LinearGradient(colors: [
          TColor.primaryColor2.withOpacity(0.5),
          TColor.primaryColor1.withOpacity(0.5),
